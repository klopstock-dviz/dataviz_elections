class params_tick {
    constructor() {
      ...
      this.selection_params = {selection_mode: "filter", selection_level: "all", brush: {mode:"brushEndEvent", axis: "x"}}
      ...
      this.funcLib = {}
      this.style = {chart_width: 400, boxShadow: true, aspectRatio: 0.2}
      this.animation_params = {ease_function: "easeInBack", speed: 3}
    }
  }
