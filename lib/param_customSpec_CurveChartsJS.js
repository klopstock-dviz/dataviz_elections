...
class param_customSpec_CurveChartsJS {
  constructor() {
/*    mobx.extendObservable(this, {
    ...
    this.legend = {position: 'top', labels: {usePointStyle : true}}
    this.legend_title = ""
    this.legend_clicked = false
    this.title = 'set a title in the params spec'
    ...
    this.data_main = []
    this.interactions_chart_options = {hoverOptions: false, selectionOptions: true}
    this.active_legends = {}
    this.hidden_legends = {}
    this.previous_hiearchy = {}
    this.selection_params = {interaction_mode: "filter", selection_level: "all", selection_field: "", highlight_mode: "all", brush:{active: true, mode: "brushEndEvent", axis: "x"}}
    ...
    //brushEvent & highlightEvent for continuous refresh, brushEndEvent & highlightEndEvent for a refresh at the end of brush move/sizing
    this.chart_area = {}
    this.brush_area = {}    
    this.legends_field = ""
