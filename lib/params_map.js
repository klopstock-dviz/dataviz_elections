class params_map {
  constructor() {
    ...
    this.legends_field = ""
    this.dataset_extent = {}
    this.params_fields = {hue_params: {domain: ["min", "max"]}, size_params: {min_radius: 15, max_radius: 100, scale_method: "scaleSqrt", resize_on_zoom: true}} //scale_method= scaleSqrt || scaleLinear
    this.interaction_type = ""
    this.legendColors = []
    this.params_legends = {show: true, position: "", shape: "", nb_cells: 8, circling_datapoints: false, flyToBounds: false}
    this.params_datapoints = {}
    this.leaflet_polys_id_selected = []
    this.limit_decimation = 5000
    this.target_scatterPlots = []
    this.id_previous_singleSelect = ""
    this.id_previous_multiSelect = ""
    this.map_height = undefined
    this.map_width = undefined
    this.funcLib = {}
    this.dataset_timeDelay_param = [{dataset_length: {min:0, max: 3000}, time_delay: 100},
      {dataset_length: {min:3001, max: 5000}, time_delay: 0},//300
      {dataset_length: {min:5001, max: 7000}, time_delay: 0},//600
      {dataset_length: {min:7001, max: 9000}, time_delay: 0},//800
      {dataset_length: {min:9001, max: 20000}, time_delay: 0}]//1000
    this.droplist_fields_threshold = 3
    this.tileLayers_opacity = 0.75
    this.tileLayer_minOpacity = 0.3
    this.tileLayer_weight = 2
    this.legends_crossfilter = true
    this.selected_polygons = []
    this.pin_adresses = {}
    this.style ={chart_width:700}
    this.animCircleSizing_timing = {}
  }
}
