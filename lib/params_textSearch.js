class params_textSearch {
	constructor() {
		...
		this.search_mode = 'startsWith' //or includes
		this.search_results_length = 5 //define the nb of items in the returned list of results 
		this.box_selected_items = {position: 'bottom'}
		this.sliders = true
		this.pin_adresses = {}
	}
}