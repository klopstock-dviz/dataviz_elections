...
class param_customSpec_BarChartsJS {
  constructor() {
    ...
    this.legend = {position: 'top', title: "title legend", reverse: false, labels: {boxWidth: 25, padding: 10}}    
    ...
    this.params_xAxis = {ticks: {beginAtZero: true, display: true}}
    this.params_yAxis = {ticks: {beginAtZero: true, display: true}}
    ...
    this.active_legends = {}
    this.hidden_legends = {}
    this.previous_hierarchy = {}
    this.id_previous_singleSelect = ""
    this.id_previous_multiSelect = ""    
    this.history_data_filtred = {}
    this.funcLib = {}
    this.brush_mode = true
    this.style ={chart_width: 450, aspectRatio: 0.625, boxShadow: true}
    this.params_scales = {animationDuration: 2000, delayDuration: 0}
