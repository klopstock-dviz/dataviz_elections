class Map_circles {
	...
	init_chart(params_chart, sharedParams) {		
		...
		//create the title
			...
			//2.create outer div
			var container = document.createElement('div'); container.style.display = 'grid'; container.id = "general_container_" + params_chart.htmlNode
			//3.create the title
		...
		//create layer for the controls
			...
			//create control for brush rect
				var controlBrushRect = document.createElement('i'); controlBrushRect.className = "fa fa-square-o"; controlBrushRect.ariaHidden = 'true'; controlBrushRect.id = params_chart.htmlNode + "brushRect_" + params_chart.htmlNode
				controlBrushRect.style.fontSize = "x-large"; controlBrushRect.addEventListener("mouseover", function(evt){ 			        	
			...
			//create control for brush circle
				var controlBrushCircle = document.createElement('i'); controlBrushCircle.className = "fa fa-circle-thin"; controlBrushCircle.ariaHidden = 'true'; controlBrushCircle.id = "brushCircle_" + params_chart.htmlNode
				controlBrushCircle.style.fontSize = "x-large"; 
	...
	inject_metadata(mymap, params_chart, data_type, injection_type, updateTime) {
	   params_chart.moveend = []; params_chart.zoomend = [];
		...
		calculate_transition_times(params_chart, sharedParams)
	...
	setup_defaults_parameters(params_chart, sharedParams) {
		...
		//set color mode according to user config
		if (params_chart.params_fields.hue_params) {
			...
			params_chart.params_datapoints.circles_color_mode = "discrecte_color"
		}
